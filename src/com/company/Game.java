...
public class Game {
    ...
    public boolean generateCards(List<CardTypes> cardtypesShuffledList, List<Integer> numbersShuffledList){
        ...
        for(int i=0; i<GameConstants.MAXDECKCAPACITY.value(); i++) {
            ...
            if (card == null){
                System.out.println("Couldn't create card, either invalid number or non-existing type");
                return false;
            }
            else
